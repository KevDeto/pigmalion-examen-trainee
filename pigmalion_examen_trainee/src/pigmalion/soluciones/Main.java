...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println(recursos_infinitos.sumaDeDosElementosEsIgualANumero(nums1, 8));
		System.out.println(recursos_infinitos.sumaDeDosElementosEsIgualANumero(nums2, 8));
		
		System.out.println(recursos_limitados.sumaDeDosElementosEsIgualANumero(nums1, 8));
